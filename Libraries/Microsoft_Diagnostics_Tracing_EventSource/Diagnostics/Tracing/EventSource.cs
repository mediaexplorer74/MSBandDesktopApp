              ...
              else
              {
                ...
                if (!eventAttribute.IsOpcodeSet)
                {
                  ...
                  if (flag2)
                  {
                    ...
                    else if (eventAttribute.Opcode == EventOpcode.Stop)
                    {
                      ...
                      else if ((flags & EventManifestOptions.Strict) != EventManifestOptions.None)
                ...
                if (source == null || !source.SelfDescribingEvents)
                {
                  ...
                  for (int index3 = 0; index3 < parameters.Length; ++index3)
                    manifest.AddEventParameter(parameters[index3].ParameterType, parameters[index3].Name);
                  manifest.EndEvent();
                }
                if (source != null || (flags & EventManifestOptions.Strict) != EventManifestOptions.None)
                {
    ...
    private struct Sha1ForNonSecretPurposes
    {
      ...
      private void Drain()
      {
        ...
        for (int index = 20; index != 40; ++index)
        {
          ...
          uint num7 = (uint) ((int) EventSource.Sha1ForNonSecretPurposes.Rol5(input1) + (int) num6 + (int) num3 + 1859775393) + this.w[index];
          num3 = num2;
          num2 = num1;
          num1 = EventSource.Sha1ForNonSecretPurposes.Rol30(input2);
          input2 = input1;
        ...
        for (int index = 40; index != 60; ++index)
        {
          ...
          uint num9 = (uint) ((int) EventSource.Sha1ForNonSecretPurposes.Rol5(input1) + (int) num8 + (int) num3 - 1894007588) + this.w[index];
          num3 = num2;
          num2 = num1;
          num1 = EventSource.Sha1ForNonSecretPurposes.Rol30(input2);
          input2 = input1;
        ...
        for (int index = 60; index != 80; ++index)
        {
          ...
          uint num11 = (uint) ((int) EventSource.Sha1ForNonSecretPurposes.Rol5(input1) + (int) num10 + (int) num3 - 899497514) + this.w[index];
          num3 = num2;
          num2 = num1;
          num1 = EventSource.Sha1ForNonSecretPurposes.Rol30(input2);
          input2 = input1;
