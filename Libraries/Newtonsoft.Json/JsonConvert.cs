...
namespace Newtonsoft.Json
{
  public static class JsonConvert
  {
    ...
    public static Task<string> SerializeObjectAsync(object value) => JsonConvert.SerializeObjectAsync(value, Formatting.None, (JsonSerializerSettings) null);
    ...
    public static Task<string> SerializeObjectAsync(object value, Formatting formatting) => JsonConvert.SerializeObjectAsync(value, formatting, (JsonSerializerSettings) null);
    ...
    public static Task<string> SerializeObjectAsync(
      object value,
      Formatting formatting,
      JsonSerializerSettings settings)
    {
      return Task.Factory.StartNew<string>((Func<string>) (() => JsonConvert.SerializeObject(value, formatting, settings)));
    }
    ...
    public static Task<T> DeserializeObjectAsync<T>(string value) => JsonConvert.DeserializeObjectAsync<T>(value, (JsonSerializerSettings) null);
    ...
    public static Task<T> DeserializeObjectAsync<T>(
      string value,
      JsonSerializerSettings settings)
    {
      return Task.Factory.StartNew<T>((Func<T>) (() => JsonConvert.DeserializeObject<T>(value, settings)));
    }
    ...
    public static Task<object> DeserializeObjectAsync(string value) => JsonConvert.DeserializeObjectAsync(value, (Type) null, (JsonSerializerSettings) null);
    ...
    public static Task<object> DeserializeObjectAsync(
      ...
      JsonSerializerSettings settings)
    {
      return Task.Factory.StartNew<object>((Func<object>) (() => JsonConvert.DeserializeObject(value, type, settings)));
    }
    ...
    public static Task PopulateObjectAsync(
      ...
      JsonSerializerSettings settings)
    {
      return Task.Factory.StartNew((Action) (() => JsonConvert.PopulateObject(value, target, settings)));
    }
