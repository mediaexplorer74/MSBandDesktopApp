    ...
    internal static int Compare(JTokenType valueType, object objA, object objB)
    {
      ...
      switch (valueType)
      {
        ...
        case JTokenType.Float:
          ...
          return objB is BigInteger i1_8 ? -JValue.CompareBigInteger(i1_8, objA) : JValue.CompareFloat(objA, objB);
...
label_28:
    ...
    protected override DynamicMetaObject GetMetaObject(Expression parameter) => (DynamicMetaObject) new DynamicProxyMetaObject<JValue>(parameter, this, (DynamicProxy<JValue>) new JValue.JValueDynamicProxy(), true);
    ...
    TypeCode IConvertible.GetTypeCode()
    {
      ...
      return this._value is BigInteger ? TypeCode.Object : System.Type.GetTypeCode(this._value.GetType());
    }
