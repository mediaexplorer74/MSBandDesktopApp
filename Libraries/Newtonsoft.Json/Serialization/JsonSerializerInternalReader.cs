...
namespace Newtonsoft.Json.Serialization
{
  internal class JsonSerializerInternalReader : JsonSerializerInternalBase
  {
    ...
    public void Populate(JsonReader reader, object target)
    {
      ...
      {
        JsonArrayContract contract = jsonContract.ContractType == JsonContractType.Array ? (JsonArrayContract) jsonContract : throw JsonSerializationException.Create(reader, "Cannot populate JSON array onto type '{0}'.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) type));
    ...
    private JsonContract GetContractSafe(Type type) => type == (Type) null ? (JsonContract) null : this.Serializer._contractResolver.ResolveContract(type);
    ...
    private static bool CoerceEmptyStringToNull(Type objectType, JsonContract contract, string s) => string.IsNullOrEmpty(s) && objectType != (Type) null && objectType != typeof (string) && objectType != typeof (object) && contract != null && contract.IsNullable;
      ...
      object existingValue)
    {
      ...
      {
        if (!(reader is JTokenReader reader4))
        {
          reader4 = (JTokenReader) JToken.ReadFrom(reader).CreateReader();
          reader4.Culture = reader.Culture;
          reader4.DateFormatString = reader.DateFormatString;
          reader4.DateParseHandling = reader.DateParseHandling;
          reader4.DateTimeZoneHandling = reader.DateTimeZoneHandling;
          reader4.FloatParseHandling = reader.FloatParseHandling;
          reader4.SupportMultipleContent = reader.SupportMultipleContent;
          this.CheckedRead((JsonReader) reader4);
          reader = (JsonReader) reader4;
        }
        object newValue;
        if (this.ReadMetadataPropertiesToken(reader4, ref objectType1, ref contract, member, containerContract, containerMember, existingValue, out newValue, out id))
          return newValue;
      }
      else
      {
      ...
      switch (contract.ContractType)
      {
        ...
        case JsonContractType.Dictionary:
          ...
          if (existingValue == null)
          {
            ...
            if (createdFromNonDefaultCreator2)
            {
              ...
              if (!contract1.HasParametrizedCreator)
        ...
        case JsonContractType.Dynamic:
          ...
          return this.CreateDynamic(reader, contract2, member, id);
        case JsonContractType.Serializable:
      ...
      out string id)
    {
      ...
      if (reader.TokenType == JsonToken.StartObject)
      {
        ...
        if (jtoken1 != null)
        {
          JToken jtoken2 = jtoken1.Type == JTokenType.String || jtoken1.Type == JTokenType.Null ? (JToken) jtoken1.Parent : throw JsonSerializationException.Create((IJsonLineInfo) jtoken1, jtoken1.Path, "JSON reference {0} property must have a string or null value.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) "$ref"), (Exception) null);
          JToken jtoken3 = (JToken) null;
          if (jtoken2.Next != null)
            jtoken3 = jtoken2.Next;
          else if (jtoken2.Previous != null)
            jtoken3 = jtoken2.Previous;
          string reference = (string) jtoken1;
          if (reference != null)
          {
            if (jtoken3 != null)
              throw JsonSerializationException.Create((IJsonLineInfo) jtoken3, jtoken3.Path, "Additional content found in JSON reference object. A JSON reference object should only have a {0} property.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) "$ref"), (Exception) null);
        ...
        JToken jtoken4 = currentToken["$type"];
        if (jtoken4 != null)
        {
          string qualifiedTypeName = (string) jtoken4;
          JsonReader reader1 = jtoken4.CreateReader();
        ...
        JToken jtoken5 = currentToken["$id"];
        if (jtoken5 != null)
          id = (string) jtoken5;
        JToken jtoken6 = currentToken["$values"];
        if (jtoken6 != null)
        {
          JsonReader reader2 = jtoken6.CreateReader();
      ...
      Type targetType)
    {
      ...
      try
      {
        ...
        return value is BigInteger i2 ? ConvertUtils.FromBigInteger(i2, contract.NonNullableUnderlyingType) : Convert.ChangeType(value, contract.NonNullableUnderlyingType, (IFormatProvider) culture);
      }
      catch (Exception ex)
      {
    ...
    private bool ShouldSetPropertyValue(JsonProperty property, object value) => (property.NullValueHandling.GetValueOrDefault(this.Serializer._nullValueHandling) != NullValueHandling.Ignore || value != null) && (!this.HasFlag(property.DefaultValueHandling.GetValueOrDefault(this.Serializer._defaultValueHandling), DefaultValueHandling.Ignore) || this.HasFlag(property.DefaultValueHandling.GetValueOrDefault(this.Serializer._defaultValueHandling), DefaultValueHandling.Populate) || !MiscellaneousUtils.ValueEquals(value, property.GetResolvedDefaultValue())) && property.Writable;
      ...
      string id)
    {
      ...
      if (contract.DefaultCreator == null || contract.DefaultCreatorNonPublic && this.Serializer._constructorHandling != ConstructorHandling.AllowNonPublicDefaultConstructor)
        throw JsonSerializationException.Create(reader, "Unable to find a default constructor to use for type {0}.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) contract.UnderlyingType));
      IDynamicMetaObjectProvider dynamicProvider = (IDynamicMetaObjectProvider) contract.DefaultCreator();
      if (id != null)
        this.AddReference(reader, id, (object) dynamicProvider);
      this.OnDeserializing(reader, (JsonContract) contract, (object) dynamicProvider);
      int depth = reader.Depth;
      bool flag = false;
      do
      {
          ...
          case JsonToken.PropertyName:
            ...
            try
            {
              ...
              if (closestMatchProperty != null && closestMatchProperty.Writable && !closestMatchProperty.Ignored)
              {
                ...
                if (!this.SetPropertyValue(closestMatchProperty, converter, (JsonContainerContract) null, member, reader, (object) dynamicProvider))
                {
                  reader.Skip();
                  break;
                }
              ...
              contract.TrySetMember(dynamicProvider, str, obj);
              break;
            }
            catch (Exception ex)
            {
              if (this.IsErrorHandled((object) dynamicProvider, (JsonContract) contract, (object) str, reader as IJsonLineInfo, reader.Path, ex))
              {
                this.HandleError(reader, true, depth);
                break;
              }
      ...
      while (!flag && reader.Read());
      if (!flag)
        this.ThrowUnexpectedEndException(reader, (JsonContract) contract, (object) dynamicProvider, "Unexpected end when deserializing object.");
      this.OnDeserialized(reader, (JsonContract) contract, (object) dynamicProvider);
      return (object) dynamicProvider;
    }
      ...
      string id)
    {
      ...
      IDictionary<JsonProperty, object> dictionary1 = this.ResolvePropertyAndCreatorValues(contract, containerProperty, reader, underlyingType, out extensionData);
      object[] objArray = new object[contract.CreatorParameters.Count];
      IDictionary<JsonProperty, object> dictionary2 = (IDictionary<JsonProperty, object>) new Dictionary<JsonProperty, object>();
      foreach (KeyValuePair<JsonProperty, object> keyValuePair in (IEnumerable<KeyValuePair<JsonProperty, object>>) dictionary1)
      {
        ...
        if (jsonProperty != null)
        {
          ...
          dictionary2.Add(keyValuePair);
        if (propertiesPresence != null)
        {
          JsonProperty key2 = propertiesPresence.Keys.ForgivingCaseSensitiveFind<JsonProperty>((Func<JsonProperty, string>) (p => p.PropertyName), key1.PropertyName);
          if (key2 != null)
          {
            object obj = keyValuePair.Value;
            JsonSerializerInternalReader.PropertyPresence propertyPresence = obj != null ? (!(obj is string) ? JsonSerializerInternalReader.PropertyPresence.Value : (JsonSerializerInternalReader.CoerceEmptyStringToNull(key1.PropertyType, key1.PropertyContract, (string) obj) ? JsonSerializerInternalReader.PropertyPresence.Null : JsonSerializerInternalReader.PropertyPresence.Value)) : JsonSerializerInternalReader.PropertyPresence.Null;
            propertiesPresence[key2] = propertyPresence;
          }
        }
      }
      if (propertiesPresence != null)
      ...
      foreach (KeyValuePair<JsonProperty, object> keyValuePair in (IEnumerable<KeyValuePair<JsonProperty, object>>) dictionary2)
      {
        ...
        if (this.ShouldSetPropertyValue(key, obj2))
        ...
        else if (!key.Writable && obj2 != null)
        {
          ...
          else if (jsonContract.ContractType == JsonContractType.Dictionary)
          {
            ...
            object dictionary3 = key.ValueProvider.GetValue(obj1);
            if (dictionary3 != null)
            {
              IDictionary dictionary4 = dictionaryContract.ShouldCreateWrapper ? (IDictionary) dictionaryContract.CreateWrapper(dictionary3) : (IDictionary) dictionary3;
              foreach (DictionaryEntry dictionaryEntry in dictionaryContract.ShouldCreateWrapper ? (IDictionary) dictionaryContract.CreateWrapper(obj2) : (IDictionary) obj2)
      ...
      if (extensionData != null)
      {
        foreach (KeyValuePair<string, object> keyValuePair in (IEnumerable<KeyValuePair<string, object>>) extensionData)
          contract.ExtensionDataSetter(obj1, keyValuePair.Key, keyValuePair.Value);
      }
      this.EndObject(obj1, reader, contract, reader.Depth, propertiesPresence);
