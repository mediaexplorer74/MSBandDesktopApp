...
namespace Newtonsoft.Json.Serialization
{
  internal class JsonSerializerInternalWriter : JsonSerializerInternalBase
  {
    ...
    public void Serialize(JsonWriter jsonWriter, object value, Type objectType)
    {
      ...
      this._rootContract = objectType != (Type) null ? this.Serializer._contractResolver.ResolveContract(objectType) : (JsonContract) null;
    ...
    private bool ShouldWriteProperty(object memberValue, JsonProperty property) => (property.NullValueHandling.GetValueOrDefault(this.Serializer._nullValueHandling) != NullValueHandling.Ignore || memberValue != null) && (!this.HasFlag(property.DefaultValueHandling.GetValueOrDefault(this.Serializer._defaultValueHandling), DefaultValueHandling.Ignore) || !MiscellaneousUtils.ValueEquals(memberValue, property.GetResolvedDefaultValue()));
      ...
      int[] indices)
    {
      ...
      for (int index = 0; index < values.GetLength(length); ++index)
      {
        ...
        if (indices1.Length == values.Rank)
        {
          ...
          {
            if (this.IsErrorHandled((object) values, (JsonContract) contract, (object) index, (IJsonLineInfo) null, writer.ContainerPath, ex))
      ...
      out bool escape)
    {
      if (contract.ContractType == JsonContractType.Primitive)
      {
        ...
        if (primitiveContract.TypeCode == PrimitiveTypeCode.DateTime || primitiveContract.TypeCode == PrimitiveTypeCode.DateTimeNullable)
        {
          ...
          DateTimeUtils.WriteDateTimeString((TextWriter) stringWriter, (DateTime) name, writer.DateFormatHandling, writer.DateFormatString, writer.Culture);
