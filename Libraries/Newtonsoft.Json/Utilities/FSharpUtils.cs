  ...
  internal static class FSharpUtils
  {
    ...
    public static void EnsureInitialized(Assembly fsharpCoreAssembly)
    {
      ...
      lock (FSharpUtils.Lock)
      {
        ...
        FSharpUtils.IsUnion = JsonTypeReflector.ReflectionDelegateFactory.CreateMethodCall<object>((MethodBase) type1.GetMethod("IsUnion", BindingFlags.Static | BindingFlags.Public));
        FSharpUtils.GetUnionCases = JsonTypeReflector.ReflectionDelegateFactory.CreateMethodCall<object>((MethodBase) type1.GetMethod("GetUnionCases", BindingFlags.Static | BindingFlags.Public));
    ...
    private static MethodCall<object, object> CreateFSharpFuncCall(
      ...
      string methodName)
    {
      MethodInfo method1 = type.GetMethod(methodName, BindingFlags.Static | BindingFlags.Public);
    ...
    public static ObjectConstructor<object> CreateSeq(Type t) => JsonTypeReflector.ReflectionDelegateFactory.CreateParametrizedConstructor((MethodBase) FSharpUtils._ofSeq.MakeGenericMethod(t));
