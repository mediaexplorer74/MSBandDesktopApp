...
namespace Newtonsoft.Json.Utilities
{
    ...
    IEnumerable
  {
    ...
    public virtual IEnumerator<T> GetEnumerator() => this._genericCollection != null ? this._genericCollection.GetEnumerator() : this._list.Cast<T>().GetEnumerator();

    IEnumerator IEnumerable.GetEnumerator() => this._genericCollection != null ? (IEnumerator) this._genericCollection.GetEnumerator() : this._list.GetEnumerator();
    ...
    public object UnderlyingCollection => this._genericCollection != null ? (object) this._genericCollection : (object) this._list;
  }
}
