      ...
      out ObjectConstructor<object> parameterizedCreator)
    {
      if (underlyingType.IsGenericType())
      {
        ...
        if (collectionTypeInfo != null)
        {
          ...
          {
            MethodInfo methodInfo1 = ((IEnumerable<MethodInfo>) type2.GetMethods()).FirstOrDefault<MethodInfo>((Func<MethodInfo, bool>) (m => m.Name == "CreateRange" && m.GetParameters().Length == 1));
            if (methodInfo1 != (MethodInfo) null)
            {
              createdType = type1.MakeGenericType(collectionItemType);
              MethodInfo methodInfo2 = methodInfo1.MakeGenericMethod(collectionItemType);
              parameterizedCreator = JsonTypeReflector.ReflectionDelegateFactory.CreateParametrizedConstructor((MethodBase) methodInfo2);
              return true;
            }
          }
        }
      ...
      out ObjectConstructor<object> parameterizedCreator)
    {
      if (underlyingType.IsGenericType())
      {
        ...
        if (collectionTypeInfo != null)
        {
          ...
          if (type1 != (Type) null && type2 != (Type) null)
          {
            MethodInfo methodInfo1 = ((IEnumerable<MethodInfo>) type2.GetMethods()).FirstOrDefault<MethodInfo>((Func<MethodInfo, bool>) (m =>
            {
            ...
            if (methodInfo1 != (MethodInfo) null)
            {
              ...
              MethodInfo methodInfo2 = methodInfo1.MakeGenericMethod(keyItemType, valueItemType);
              parameterizedCreator = JsonTypeReflector.ReflectionDelegateFactory.CreateParametrizedConstructor((MethodBase) methodInfo2);
              return true;
            }
          }
