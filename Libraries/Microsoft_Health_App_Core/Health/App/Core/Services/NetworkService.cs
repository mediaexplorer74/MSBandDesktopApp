...
namespace Microsoft.Health.App.Core.Services
{
  public class NetworkService : INetworkService
  {
    ...
    public bool IsInternetAvailable => this.connectivity.IsConnected;

    public bool OnWifi => this.connectivity.ConnectionTypes.Any<ConnectionType>((Func<ConnectionType, bool>) (c => c == 1));
