...
// Type: Microsoft.Health.App.Core.ViewModels.Workouts.Pre.WorkoutGroupViewModel
...
{
  public class WorkoutGroupViewModel : ExpandableWorkoutItemViewModel
  {
    public WorkoutGroupViewModel() => this.PropertyChanged += new PropertyChangedEventHandler(this.OnPropertyChanged);
