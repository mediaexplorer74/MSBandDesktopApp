...
// Type: Microsoft.Health.App.Core.ViewModels.Calories.CaloriesDailyViewModel
...
{
  [PageTaxonomy(new string[] {"Fitness", "Calories", "Daily"})]
  public class CaloriesDailyViewModel : StatDailyViewModelBase<CaloriesDayViewModel>
  {
    public CaloriesDailyViewModel(
    ...
    protected override int GetStatHistoryEntryCount(UserDailySummaryGroup userDailySummaryGroup) => userDailySummaryGroup.TotalCaloriesBurned;
  }
}
