...
namespace Cirrious.MvvmCross.Views
{
  public abstract class MvxViewsContainer : IMvxViewsContainer, IMvxViewFinder
  {
    ...
    public Type GetViewType(Type viewModelType)
    {
      ...
      Type type2 = this._lastResortViewFinder != null ? this._lastResortViewFinder.GetViewType(viewModelType) : throw new KeyNotFoundException("Could not find view for " + (object) viewModelType);
