...
namespace Cirrious.MvvmCross.ViewModels
{
  public class MvxViewModelViewLookupBuilder : IMvxTypeToTypeLookupBuilder
  {
    public virtual IDictionary<Type, Type> Build(Assembly[] sourceAssemblies)
    {
      ...
      }).Where(_param0 => (object) _param0.viewModelType != null).Select(_param0 => new KeyValuePair<Type, Type>(_param0.viewModelType, _param0.\u003C\u003Eh__TransparentIdentifier0.candidateViewType));
      try
      {
