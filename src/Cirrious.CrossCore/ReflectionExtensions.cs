...
namespace Cirrious.CrossCore
{
  public static class ReflectionExtensions
  {
      ...
      BindingFlags flags)
    {
      ...
      {
        _TransparentIdentifier4 = _param0,
        setMethod = _param0.property.SetMethod
      }).Where(_param0 => (object) _param0._TransparentIdentifier4.getMethod != null 
      || (object) _param0.setMethod != null).Where(_param1 => (flags & BindingFlags.Public) != BindingFlags.Public 
      || _param1._TransparentIdentifier4.getMethod.NullSafeIsPublic() 
      || _param1.setMethod.NullSafeIsPublic()).Where(_param1 => (flags & BindingFlags.Instance) != BindingFlags.Instance 
      || !_param1._TransparentIdentifier4.getMethod.NullSafeIsStatic() 
      || !_param1.setMethod.NullSafeIsStatic()).Where(_param1 => (flags & BindingFlags.Static) != BindingFlags.Static 
      || _param1._TransparentIdentifier4.getMethod.NullSafeIsStatic() 
      || _param1.setMethod.NullSafeIsStatic()).Select(_param0 => _param0._TransparentIdentifier4.property);
    }
