...
namespace DesktopSyncApp
{
  public sealed partial class App : Application, IDisposable
  {
    ...
    private bool _contentLoaded;
        ...
        // * ME * : 'new' added
        public new AppMainWindow MainWindow
        {
            get
            {
                return base.MainWindow as AppMainWindow;
            }

            set
            {
                this.MainWindow = value;//(Window) value;
            }
        }
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
      ...
      else
      {
        ...
        this.DispatcherUnhandledException += 
                    new DispatcherUnhandledExceptionEventHandler(this.App_DispatcherUnhandledException);
        AppDomain.CurrentDomain.UnhandledException +=
                    new UnhandledExceptionEventHandler(this.CurrentDomain_UnhandledException);
        base.OnStartup(e);
        DynamicSettings dynamicSettings = new DynamicSettings();
        this.model = new ViewModel1(this, dynamicSettings, this.ParseCommandLine(e.Args));
    ...
    private void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
    {
      ErrorInfo error = new ErrorInfo(
          nameof (CurrentDomain_UnhandledException), 
    ...
    private void ShowAppTaskHandler()
    {
