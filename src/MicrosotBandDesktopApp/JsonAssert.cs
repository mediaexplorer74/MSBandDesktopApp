...
namespace DesktopSyncApp
{
  public static class JsonAssert
  {
    ...
    public static void PropertyIsGreaterOrEqualToZero(string propertyName, Length value) => JsonAssert.IsTrue((((Length) value).TotalMillimeters >= 0.0 ? 1 : 0) != 0, "Property '{0}' cannot have a negative value: {1}", (object) propertyName, (object) value);

    public static void PropertyIsGreaterOrEqualToZero(string propertyName, Weight value) => JsonAssert.IsTrue((((Weight) value).TotalGrams >= 0.0 ? 1 : 0) != 0, "Property '{0}' cannot have a negative value: {1}", (object) propertyName, (object) value);
    ...
    public static void PropertyIsGreaterOrEqualToZero(string propertyName, Speed value) => JsonAssert.IsTrue((((Speed) value).MillisecondsPerKilometer >= 0.0 ? 1 : 0) != 0, "Property '{0}' cannot have a negative value: {1}", (object) propertyName, (object) value);
