    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      ...
      catch
      {
        ...
        public string Convert(FirmwareVersions value)
        {
            ...
            (
                Strings.Format_FirmwareVersion, 
                (object)value.ApplicationVersion, 
                (object)value.PcbId, 
                value.ApplicationVersion.Debug 
                    ? (object)Strings.FirmwareVersionDebugAbbr 
                    : (object)Strings.FirmwareVersionReleaseAbbr
            );
        }

        public string Convert(Version value)
        {
            return string.Format(Strings.Format_FirmwareVersionShort, (object)value);
        }
