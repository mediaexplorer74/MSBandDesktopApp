  ...
  public class FirmwareUpdateProgress : KDKProgress<FirmwareUpdateProgress>
  {
    ...
    public double? LatestProgressPercentage
    {
      ...
      set
      {
        ...
        if ((progressPercentage.GetValueOrDefault() == nullable.GetValueOrDefault() 
                    ? (progressPercentage.HasValue != nullable.HasValue ? 1 : 0) : 1) == 0)
          return;
    ...
    public FirmwareUpdateState? LatestState
    {
      ...
      set
      {
        ...
        if ((latestState.GetValueOrDefault() == nullable.GetValueOrDefault() 
                    ? (latestState.HasValue != nullable.HasValue ? 1 : 0) : 1) == 0)
          return;
