...
{
  public partial class AnimatedPageControl1 : Grid, IComponentConnector
  {
      ...
      if (syncAppPageControl != null)
      {
        if (this.modalPageStack.Count == 0 & animate)
        {
          ...
          switch (direction)
          {
            ...
            doubleAnimation.Duration = (Duration)default;//AnimatedPageControl.slideDuration;
            doubleAnimation.AccelerationRatio = 0.2;//AnimatedPageControl.accRatio;
            doubleAnimation.DecelerationRatio = 0.1;//AnimatedPageControl.decRatio;
