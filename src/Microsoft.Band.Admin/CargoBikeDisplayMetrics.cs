...
namespace Microsoft.Band.Admin
{
  public class CargoBikeDisplayMetrics
  {
    ...
    {
      foreach (BikeDisplayMetricType displayMetricType in ((IEnumerable<BikeDisplayMetricType>) this.metrics).Take<BikeDisplayMetricType>(constants.BikeMetricsDisplaySlotCount))
