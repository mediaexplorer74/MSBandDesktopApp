  ...
  public class FiddlerLogService : IFiddlerLogService
  {
    ...
    public async Task StartAsync(CancellationToken token)
    {
      ...
      try
      {
        ...
        bool logFileExists;
        using (Stream scanStream = await this.zipArchiveFile.OpenAsync(PCLStorage.FileAccess.Read, token).ConfigureAwait(false))
        {
    ...
    private async Task OpenArchiveStreamAsync(CancellationToken token)
    {
      ...
      Stream stream = await this.zipArchiveFile.OpenAsync(
      ...
      Stream outputStream)
    {
      ...
      if (nullable.HasValue)
      {
        ...
        //_Boxed<DateTimeOffset>
        ValueType local1 = (ValueType) nullable.Value;
        ...
        // ISSUE: variable of a boxed type
        //_Boxed<DateTimeOffset>
        ValueType local2 = (ValueType) nullable.Value;
        ...
        // ISSUE: variable of a boxed type
        //_Boxed<DateTimeOffset>
        ValueType local3 = (ValueType) nullable.Value;
        ...
        // ISSUE: variable of a boxed type
        //_Boxed<DateTimeOffset>
        ValueType local4 = (ValueType) nullable.Value;
      ...
      if (nullable.HasValue)
      {
        ...
        // ISSUE: variable of a boxed type
        //_Boxed<DateTimeOffset>
        ValueType local = (ValueType) nullable.Value;
