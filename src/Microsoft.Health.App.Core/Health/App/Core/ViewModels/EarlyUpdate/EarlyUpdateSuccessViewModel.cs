...
// Type: Microsoft.Health.App.Core.ViewModels.EarlyUpdate.EarlyUpdateSuccessViewModel
...
{
  public class EarlyUpdateSuccessViewModel
  {
    private ISmoothNavService navService;
    private HealthCommand doneCommand;

    public EarlyUpdateSuccessViewModel(ISmoothNavService navService) => this.navService = navService;
