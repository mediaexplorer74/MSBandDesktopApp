...
// Type: Microsoft.Health.App.Core.ViewModels.Steps.StepsWeeklyViewModel
...
{
  [PageTaxonomy(new string[] {"Fitness", "Steps", "Weekly"})]
  public class StepsWeeklyViewModel : StatWeeklyViewModelBase<StepsWeekViewModel>
  {
    public StepsWeeklyViewModel(
    ...
    protected override int GetHistoryStatEntryCount(UserDailySummaryGroup userDailySummaryGroup) => userDailySummaryGroup.TotalStepsTaken;
  }
}
