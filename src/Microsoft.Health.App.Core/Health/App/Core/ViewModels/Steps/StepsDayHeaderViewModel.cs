...
// Type: Microsoft.Health.App.Core.ViewModels.Steps.StepsDayHeaderViewModel
...
{
  public class StepsDayHeaderViewModel : StatDayHeaderViewModelBase
  {
    public StepsDayHeaderViewModel(
    ...
    public override async Task LoadAsync(IDictionary<string, string> parameters = null)
    {
      ...
      this.Header = Formatter.FormatSteps((int)this.SummaryGroup?.TotalStepsTaken, true).ToSerializedString();
