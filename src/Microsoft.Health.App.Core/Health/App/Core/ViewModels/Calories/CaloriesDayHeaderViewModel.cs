...
// Type: Microsoft.Health.App.Core.ViewModels.Calories.CaloriesDayHeaderViewModel
...
{
  public class CaloriesDayHeaderViewModel : StatDayHeaderViewModelBase
  {
    public CaloriesDayHeaderViewModel(
    ...
    public override async Task LoadAsync(IDictionary<string, string> parameters = null)
    {
      ...
      this.Header = Formatter.FormatCalories(new int?((int)this.SummaryGroup?.TotalCaloriesBurned), true).ToSerializedString();
