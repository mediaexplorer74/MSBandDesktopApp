...
// Type: Microsoft.Health.App.Core.Providers.Golf.Courses.GolfCourseHoleTee
...
{
  public sealed class GolfCourseHoleTee
  {
    private readonly string id;
    private readonly string name;
    private readonly int par;
    private readonly Length length;
    private readonly double strokeIndex;
    private readonly bool isDefault;

    public GolfCourseHoleTee(
      string id,
      string name,
      int par,
      Length length,
    ...
    public double StrokeIndex => this.strokeIndex;
