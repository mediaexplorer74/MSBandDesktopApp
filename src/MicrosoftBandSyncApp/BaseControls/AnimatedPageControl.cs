...
{
  public partial class AnimatedPageControl : Grid
  {
    ...
    public SyncAppPageControl TopPage => this.pageStack.Count <= 0 
            ? (SyncAppPageControl) null 
            : this.pageStack.First.Value;

    public SyncAppPageControl ModelPage => this.modalPageStack.Count <= 0 
            ? (SyncAppPageControl) null
            : this.modalPageStack.First.Value;

    public void ShowPage(SyncAppPageControl page, bool animate = true, 
        PageSlideDirection direction = PageSlideDirection.Left)
    {
      if (page == null)
    ...
    public void HideModalPage(bool animate = true)
    {
      ...
      if (syncAppPageControl2 != null)
      {
        ...
        syncAppPageControl2.IsEnabled = true;
            ...
            {
                syncAppPageControl1.RenderTransform = (Transform)new TranslateTransform(
