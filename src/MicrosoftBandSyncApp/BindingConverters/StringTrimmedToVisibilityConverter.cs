...
namespace DesktopSyncApp.BindingConverters
{
  ...
  public class StringTrimmedToVisibilityConverter : IValueConverter
  {
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => (object) this.Convert((string) value, parameter == null || !(parameter is StringTrimmedToVisibilityConverter.Mapping mapping) ? this.DefaultMapping : mapping);
