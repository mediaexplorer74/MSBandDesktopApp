...
{
  public partial class VariableOpacityButton : Button
  {
    public static readonly DependencyProperty BaseOpacityProperty 
            = DependencyProperty.Register(nameof (BaseOpacity), typeof (double), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    UIElement.OpacityProperty.DefaultMetadata.DefaultValue,
                    new PropertyChangedCallback(VariableOpacityButton.BaseOpacityPropertyChanged)));
   
        public static readonly DependencyProperty MouseOverOpacityProperty 
            = DependencyProperty.Register(nameof (MouseOverOpacity), typeof (double), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    UIElement.OpacityProperty.DefaultMetadata.DefaultValue, 
                    new PropertyChangedCallback(VariableOpacityButton.MouseOverOpacityPropertyChanged)));
   
        public static readonly DependencyProperty MouseDownOpacityProperty 
            = DependencyProperty.Register(nameof (MouseDownOpacity), typeof (double), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    UIElement.OpacityProperty.DefaultMetadata.DefaultValue, 
                    new PropertyChangedCallback(VariableOpacityButton.MouseDownOpacityPropertyChanged)));
        ...
        public static readonly DependencyProperty MouseOverBackgroundProperty 
            = DependencyProperty.Register(nameof (MouseOverBackground), typeof (Brush), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    Control.BackgroundProperty.DefaultMetadata.DefaultValue, 
                    new PropertyChangedCallback(VariableOpacityButton.MouseOverBackgroundPropertyChanged)));
   
        public static readonly DependencyProperty MouseDownBackgroundProperty 
            = DependencyProperty.Register(nameof (MouseDownBackground), typeof (Brush), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    Control.BackgroundProperty.DefaultMetadata.DefaultValue, 
                    new PropertyChangedCallback(VariableOpacityButton.MouseDownBackgroundPropertyChanged)));
   
        public static readonly DependencyProperty BaseForegroundProperty;
    
        public static readonly DependencyProperty MouseOverForegroundProperty 
            = DependencyProperty.Register(nameof (MouseOverForeground), typeof (Brush), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    Control.ForegroundProperty.DefaultMetadata.DefaultValue, 
                    new PropertyChangedCallback(VariableOpacityButton.MouseOverForegroundPropertyChanged)));
   
        public static readonly DependencyProperty MouseDownForegroundProperty 
            = DependencyProperty.Register(nameof (MouseDownForeground), typeof (Brush), 
                typeof (VariableOpacityButton), new PropertyMetadata(
                    Control.ForegroundProperty.DefaultMetadata.DefaultValue, 
                    new PropertyChangedCallback(VariableOpacityButton.MouseDownForegroundPropertyChanged)));
