...
// Type: Microsoft.Health.Cloud.Client.Json.SecondsToTimeSpanConverter
...
namespace Microsoft.Health.Cloud.Client.Json
{
  ...
  {
    public override bool CanConvert(Type objectType) => (object) objectType == (object) typeof (TimeSpan);
