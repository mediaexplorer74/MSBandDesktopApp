  ...
  public sealed class BandTile
  {
    ...
    public string Name
    {
      ...
      set
      {
        ...
        this.name = value.Length <= 21 ? value : throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, BandResources.BandTileNameLengthExceeded, new object[1]
        {
          (object) (ushort) 21
        }), nameof (value));
      }
