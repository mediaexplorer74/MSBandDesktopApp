...
namespace DesktopSyncApp.BindingConverters
{
  ...
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => (object) this.Convert((BikeDisplayMetricType) value, (BandClass) parameter);
