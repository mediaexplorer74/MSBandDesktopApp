...
namespace DesktopSyncApp
{
  ...
  public class Strings
  {
    ...
    public static string Label_CheckBox_Checked => Strings.ResourceManager.GetString(nameof (Label_CheckBox_Checked), Strings.resourceCulture);
